...
levels(drdata$race) = list("Missing" = "?", "Other" = c("Other", "Asian", "Hispanic"), "African American" = "AfricanAmerican", "Caucasian" = "Caucasian" )
...
drdata$race = relevel(drdata$race, ref = "African American")
